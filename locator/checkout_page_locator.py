...
class CheckoutPage:
    full_name_locator = (By.XPATH, "//li[contains(@class, 'address_firstname') and contains(@class, 'address_lastname')]")
    company_name_locator = (By.XPATH, "(//li[contains(@class, 'address_address1') and contains(@class, 'address_address2')])[1]")
